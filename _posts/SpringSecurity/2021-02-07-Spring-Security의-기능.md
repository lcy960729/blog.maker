...
### 1.1.1. Authentication Support
Spring Security는 사용자 인증을위한 내장 지원을 제공합니다.
...
```
## 1.2. Protection Against Exploits (악용에 대한 보호)
스프링 시큐리티는 일반적인 악용에 대한 방어를 제공한다. 가능하면 보호 기능은 기본적으로 활성화 되어 있다. 

### 1.2.1. Cross Site Request Forgery (CSRF)
...
### 1.2.2. Security HTTP Response Headers
